        ...
        {user && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <EditableField
              ...
              icon={User}
              isDisabled={editingField !== null && editingField !== "firstName"}
            ...
            <EditableField
              ...
              value={user.lastName}
              icon={User}
              isDisabled={editingField !== null && editingField !== "lastName"}
            ...
            <EditableField
              ...
              errorMessage={editingField === "dateOfBirth" ? errorMessage : ""}
            />
            ...
            <EditableField
              ...
              value={user.whatsapp}
              icon={WhatsApp}
              isDisabled={editingField !== null && editingField !== "whatsapp"}
